...
from libs.tools.progress_bar import list_bar as prog_bar
"""
...
def create_kitti_info_file(data_path,
                           ...
                           relative_path=True):
    train_img_ids = _read_imageset_file("/home/aistudio/kitti/train.txt")
    val_img_ids = _read_imageset_file("/home/aistudio/kitti/val.txt")
    trainval_img_ids = _read_imageset_file("/home/aistudio/kitti/trainval.txt")
    test_img_ids = _read_imageset_file("/home/aistudio/kitti/test.txt")
