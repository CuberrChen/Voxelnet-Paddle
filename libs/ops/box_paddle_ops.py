...
def rotation_3d_in_axis(points, angles, axis=0):
    ...
    return paddle.to_tensor(np.einsum('aij,jka->aik', points.numpy(), rot_mat_T.numpy()))
...
def lidar_to_camera(points, r_rect, velo2cam):
    ...
    # print('camera_points',camera_points.shape)
    if(len(camera_points.shape)==1):
        camera_points = camera_points.unsqueeze(0)
