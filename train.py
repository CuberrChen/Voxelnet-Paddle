...
def train(cfg_file = None,
   ...
   # must restore optimizer AFTER using MixedPrecisionWrapper
    ...
    t = time.time()
    pd_start_time = t
    total_loop = remain_steps // train_cfg.STEPS_PER_EPOCH + 1
    clear_metrics_every_epoch = train_cfg.CLEAR_METRICS_EVERY_EPOCH

    if train_cfg.STEPS % train_cfg.STEPS_PER_EPOCH == 0:
        total_loop -= 1
    ...
    try:
        print("++++++++++++++++++++++++++++++++++++START TRAIN++++++++++++++++++++++++++++++++++++++++++++++++")
        for _ in range(total_loop): # total_loop todo adjust
            print("++++++++++++++++++++++++++++++++++++START LOOP:{}++++++++++++++++++++++++++++++++++++++++++++++++".format(_))

            if clear_metrics_every_epoch:
                net.clear_metrics()
            
            # for step in range(steps): # steps todo adjust
            for i, example in enumerate(dataloader()):
                print("++++++++++++++++++++++++++++++++++++START LOOP:{}-STEP:{}++++++++++++++++++++++++++++++++++++++++++++++++".format(_,i))
                ...
                print("++++++++++++++++++++++++++++++++++++NET_TIME:{}++++++++++++++++++++++++++++++++++++++++++++++++".format(time.time()-st))
                ...
                if global_step % display_step == 0:
                    ...
                    if use_vdl:
                        log_writer.add_scalar('Train/loss', loss.detach().cpu().numpy(), metrics["step"])
            ...
            if((_+1)%train_cfg.EPOCHS_PER_EVAL==0 or _ ==total_loop-1):
                net.eval()
